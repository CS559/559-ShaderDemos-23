...
function stripeExperiment(title,fsfile) {
    let mydiv;
    ...
    let shaderMat = shaderMaterial("simple.vs",fsfile, 
        {
            uniforms: {
                stripes: { value: 10.0},
                sw: { value: 0.5},
...
stripeExperiment("Shader Stripes (one sided)","2-stripes-aa.fs");
stripeExperiment("Shader Stripes (two sided)","3-stripes-twoside.fs");
